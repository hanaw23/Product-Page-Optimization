...
const NextArrowIcon = (props: NextArrowIconProps) => {
  return (
    <svg className={props.className} fill={props.fill} height={props.height} width={props.width} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
